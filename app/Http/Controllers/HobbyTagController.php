...
class HobbyTagController extends Controller
{
    public function getFilteredHobbies($tag_id)
    {
        ...
        return view('hobby.index', ['hobbies' => $hobbies, 'filter' =>$filter]);
    }
    ...
    public function attachTag($hobby_id, $tag_id)
    {
        ...
        return back()->with(['message_success' => "The Tag <b>" .$tag->name. "</b> was added."]);
    }
    ...
    public function detachTag($hobby_id, $tag_id)
    {
        ...
        return back()->with(['message_success' => "The Tag <b>" .$tag->name. "</b> was removed."]);
    }
